...
# OpenAI API Key와 RAG 모델 설정입니다. 실제 Key는 .env에만 저장합니다.
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")
# RAG 최종 답변을 생성할 OpenAI 모델입니다.
OPENAI_CHAT_MODEL = os.getenv("OPENAI_CHAT_MODEL", "gpt-5.6-luna")
# 문서와 질문을 벡터로 변환할 OpenAI 임베딩 모델입니다.
OPENAI_EMBEDDING_MODEL = os.getenv("OPENAI_EMBEDDING_MODEL", "text-embedding-3-small")
# 제공된 PDF 근거 문서가 저장되는 디렉터리입니다.
RAG_DOCS_DIR = BASE_DIR / "docs"
# ChromaDB 영구 벡터 데이터가 저장되는 디렉터리입니다.
RAG_VECTOR_DB_DIR = BASE_DIR / "vector_db" / "chroma"
