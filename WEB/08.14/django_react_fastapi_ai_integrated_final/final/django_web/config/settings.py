...
INSTALLED_APPS = [
    ...
    # React 개발 서버와 Django API 간 CORS를 안전하게 처리합니다.
    "corsheaders",
...
MIDDLEWARE = [
    ...
    # CORS 응답 헤더를 다른 미들웨어보다 먼저 적용합니다.
...
# React 개발 서버가 Django 세션/CSRF를 포함해 API를 호출할 수 있는 origin 목록입니다.
...
# React origin에만 CORS 접근을 허용합니다.
CORS_ALLOWED_ORIGINS = REACT_ALLOWED_ORIGINS
# fetch credentials: include로 Django 세션 쿠키를 전달할 수 있게 합니다.
CORS_ALLOW_CREDENTIALS = True
# React에서 POST/파일 업로드를 할 때 CSRF 검증을 통과할 수 있는 신뢰 origin입니다.
CSRF_TRUSTED_ORIGINS = REACT_ALLOWED_ORIGINS
# 개발 환경의 127.0.0.1/localhost 조합에서 세션과 CSRF 쿠키를 안정적으로 사용합니다.
