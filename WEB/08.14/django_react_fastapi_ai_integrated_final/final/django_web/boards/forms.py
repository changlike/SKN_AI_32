...
class BoardForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Bootstrap 입력 도움말을 위해 제목/내용에 간단한 placeholder만 추가합니다.
        self.fields["title"].widget.attrs.setdefault("placeholder", "게시글 제목을 입력하세요")
        self.fields["content"].widget.attrs.setdefault("placeholder", "게시글 내용을 입력하세요")
