...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields.values():
            # Bootstrap에서 select는 form-select, 그 외 입력 요소는 form-control을 사용합니다.
...
class LoginForm(AuthenticationForm):
    ...
    def __init__(self, request=None, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs.update({"class": "form-control", "placeholder": "회원 아이디", "autocomplete": "username"})
        # 비밀번호 입력 필드 스타일을 지정합니다.
        self.fields["password"].widget.attrs.update({"class": "form-control", "placeholder": "비밀번호", "autocomplete": "current-password"})
